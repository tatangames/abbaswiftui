//
//  TextoDevocionalViewModel.swift
//  AbbaSwiftUI
//
...
class TextoDevocionalViewModel: ObservableObject {
    ...
    func infoTextoDevocionalRX(idToken: String, idCliente: String, idBlockDeta: Int, idiomaApp: Int, completion: @escaping (Result<JSON, Error>) -> Void) {
        ...
        let encodeURL = apiTextoDevocional
