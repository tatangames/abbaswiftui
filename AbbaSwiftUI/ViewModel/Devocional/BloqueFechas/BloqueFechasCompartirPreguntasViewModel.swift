//
//  BloqueFechasCompartirPreguntasViewModel.swift
//  AbbaSwiftUI
//
...
class BloqueFechasCompartirPreguntasViewModel: ObservableObject {
    ...
    func solicitarPreguntasCompartirRX(idToken: String, idCliente: String, idiomaApp: Int, idBlockDeta: Int, completion: @escaping (Result<JSON, Error>) -> Void) {
        ...
        let encodeURL = apiMisRespuestasParaCompartir
