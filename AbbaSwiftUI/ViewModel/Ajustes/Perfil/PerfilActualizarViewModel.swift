//
//  PerfilActualizarViewModel.swift
//  AbbaSwiftUI
//
//  Created by Jonathan  Moran on 13/10/24.
//
...
class PerfilActualizarViewModel: ObservableObject {
    ...
    func actualizarPerfilRX(idToken: String,
                            idCliente: String,
                            nombre: String,
                            apellido: String,
                            fechanac: String,
