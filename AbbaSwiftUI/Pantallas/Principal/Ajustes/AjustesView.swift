...
struct AjustesView: View {
    ...
    @State private var boolActivarCambioVista = false
    ...
    var body: some View {
        NavigationStack {
            ...
            .fullScreenCover(isPresented: $boolActivarCambioVista) {
                ...
                case .none:
                    NotificacionesAjustesView()
                case .some(.contrasena):
                    PerfilView()
                case .some(.insignias):
                    PerfilView()
                case .some(.cerrarsesion):
